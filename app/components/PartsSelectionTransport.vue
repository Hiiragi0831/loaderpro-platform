...
const onSubmit = handleSubmit(async (values) => {
  ...
  try {
    const res = await fetch(`${useApi().apiUrl}/transport`, {
      method: "POST",
      ...
      <form class="flex flex-col gap-25" @submit="onSubmit">
        ...
        <div class="shadow-lg rounded bg-white">
          ...
          <div class="grid grid-cols-5 items-center gap-15 p-25">
            ...
            <FloatLabel variant="on" class="h-full">
              <InputText
                id="engine_serial_number"
                v-model="engine_serial_number"
                class="h-full"
              />
        ...
        <div class="shadow-lg rounded bg-white">
          ...
          <div class="grid grid-cols-6 items-center gap-15 p-25">
            ...
            <FloatLabel variant="on" class="h-full">
              <InputText
                id="mast_serial_number"
                v-model="mast_serial_number"
                class="h-full"
              />
