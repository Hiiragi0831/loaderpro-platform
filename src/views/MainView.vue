      ...
      <div class="container m-auto">
        ...
        <div class="grid grid-cols-[1fr_auto_1fr] gap-130 max-lg:grid-cols-1 max-lg:gap-30">
          <div class="flex flex-col gap-20">
            ...
            <form class="flex flex-col gap-20" @submit="onSubmit">
              <FloatLabel variant="on">
                <InputText id="email" name="email" v-model="email" :invalid="!!errors?.email" />
                <Message
                  v-if="errors?.email"
                  severity="error"
                  size="small"
            ...
            <Button label="Презентация платформы" variant="outlined" fluid class="mt-auto"  @click="visible = true"/>
            <Dialog v-model:visible="visible" modal header="Презентация платформы" class="w-1080">
              <video poster="@/assets/images/main/platform-preview.jpg" data-dm-button-id="download-master-button-426080486">
          ...
          <div class="w-full">
            ...
            <Divider layout="horizontal" class="!hidden max-lg:!flex" align="center"><b>ИЛИ</b></Divider>
          </div>
          <div class="flex flex-col gap-20">
            ...
            <ul class="list-image">
              ...
              <li>1616 брендов в портфеле, 25 000 тысяч товаров в наличии на складах в России.</li>
